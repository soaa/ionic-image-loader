...
var ImageLoader = (function () {
    ...
    function () {
        ...
        if (this.currentlyProcessing[currentItem.imageUrl] === undefined) {
            this.currentlyProcessing[currentItem.imageUrl] = new Promise(function (resolve, reject) {
                ...
                _this.loadFileFromUrl(currentItem.imageUrl, localDir, fileName).subscribe(function (file) {
    ...
    /**
       ...
       * @param imageUrl
       */
    ImageLoader.prototype.loadFileFromUrl = /**
       * load fileEntry from url
       * @param imageUrl
       */
    function (url, localDir, fileName) {
        var _this = this;
        return this.http.get(url, {
            responseType: 'blob',
            headers: this.config.httpHeaders
        }).pipe(switchMap(function (data) { return fromPromise(_this.file.writeFile(localDir, fileName, data, { replace: true })); }));
    };
    /**
